...
public class BooksChapters {
    ...
    public static String getBookName(int booknumber) {
        ...
        bookName.put(54, "1 தீமோத்தேயு-1 Timothy");
        bookName.put(55, "2 தீமோத்தேயு-2 Timothy");
        ...
        bookName.put(62, "1 யோவான்-1 John");
        bookName.put(63, "2 யோவான்-2 John");
        bookName.put(64, "3 யோவான்-3  John");
